...
<head>
<meta charset="UTF-8">
<title>switch文：switchPractice02</title>
</head>
<body>
	<div>
		<p>
			<%
				if(param != null){
					...
					case "0":
						...
						break;
					case "1":
						out.println("東京まで新橋 有楽町を通過します。");
						break;
					case "2":
						out.println("東京まで浜松町 新橋 有楽町を通過します。");
						break;
					case "3":
						out.println("東京まで田町 浜松町 新橋 有楽町を通過します。");
						break;
					default:
						break;		
					}
		...
		<form action="switchPractice02.jsp" method="post">
			<input type="radio" name="param" value="0">新橋 
